...
import 'package:quran_app/features/essential_moshaf_feature/presentation/cubit/essential_moshaf_cubit.dart'
    show
        ...
        StartListeningToTheNewPage;
import 'package:quran_app/features/essential_moshaf_feature/presentation/widgets/custom_convex_bottom_sheet.dart'
    show CustomBottomConvextSheet;
...
import 'package:quran_app/features/listening/presentation/cubit/listening_cubit.dart'
    show
        CheckYourNetworkConnectionState,
        NavigateToCurrentAyahPageState,
        ListeningCubit,
        ListeningState;
import 'package:quran_app/features/main/presentation/screens/settings_screens/root_app.dart'
    show RootApp;
...
class _OrdinaryMoshafScreenState extends State<OrdinaryMoshafScreen> {
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance
        .logScreenView(screenName: AppStrings.analytcsScreenMoshafScreen);
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: WillPopScope(
        ...
        child:
            ...
            //   child:
            BlocListener<ListeningCubit, ListeningState>(
              ...
              child: Stack(
                children: [
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onPanEnd:
                                        ...
                                        if (dragEndDetails.velocity
                                                .pixelsPerSecond.distance >=
                                            150) {
                                          EssentialMoshafCubit.get(context)
                                      ...
                                      child: MediaQuery.of(context)
                                          ...
                                          : SingleChildScrollView(
                                              controller: context
                                                  ...
                                                  .quranPageLandscapeVerticalScrollController,
                                              child: SizedBox(
                                                height: context.width /
                                                    AppConstants
                                                        .moshafPageAspectRatio,
                                                width: context.width,
                                                child: QuranPageView(
                                                    actualHeight:
                                                        actualHeightBeforeSafeArea,
                  ...
                  BlocConsumer<EssentialMoshafCubit, EssentialMoshafState>(
                    listenWhen: (prev, cur) =>
                        cur is StartListeningToTheNewPage,
                    listener: (context, state) {
                    ...
                    builder:
                      ...
                      return AnimatedPositioned(
                          left: EssentialMoshafCubit.get(context).isShowFihris
                              ? 0
                              : context.width,
                          right: EssentialMoshafCubit.get(context).isShowFihris
                              ? 0
                              : -context.width,
